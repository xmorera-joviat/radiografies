			...
			<button type="button" class="btn btn-info form-control panel-title" data-toggle="collapse" data-target="#Quadrat1">Alta Alumnes</button>
				<div id="Quadrat1" class="collapse">
					<div class="panel-body">
						...
						<form action="alumnaFi.php" method="POST">
							...
							echo "<tr><th align='center'>&nbspAlumne&nbsp</th><th align='center'>&nbspEliminar&nbsp</th> <th align='center'>&nbspModificar&nbsp</th></tr>";
								...
								while ($row = mysqli_fetch_assoc($taulaUsuaris)) {
								 ...
								 echo "</td>";
								   ...
								   echo "<td align='center' >";
									  echo "<form action='borrarAlumne.php' method='POST'> <input type='hidden' value='".$row['usuari_id']."' name='eliminar'> <button class='btn btn-danger' type='submit'>Borrar</button></form> ";
									  echo "</td>";
									  
									  echo "<td align='center' >";
									  echo "<form action='modificarAlumne.php' method='POST'> <input type='hidden' value='".$row['usuari_id']."' name='modificar'> <button class='btn btn-warning' type='submit'>Modificar</button></form>";
									  echo "</td>";
									  echo "</tr>";
			...
			<button type="button" class="btn btn-info form-control panel-title" data-toggle="collapse" data-target="#Quadrat3">Alta Curs</button>
				<div id="Quadrat3" class="collapse">
					<div class="panel-body">
							...
							<form action="insertarCurs.php" method="POST">
							...
							while ($row2 = mysqli_fetch_assoc ($result) ) {
								...
								if(isset($_POST['curs'])){
									if ($row2['curs_id']== $_POST['curs']){
										echo "<form action='editarCurs.php' method='POST'>
										<div class='input-group'>
										<span class='input-group-btn'>
										<button class='btn btn-warning' type='submit'>OK</button>
										</span>
										<input type='text' class='form-control' name='any' placeholder='".$row2['any']."' required>
								...
								echo "<td align='center' >";
								echo "<form action='eliminarCurs.php' method='POST'><input type='hidden' value='".$row2 ['curs_id']."' name='curs'> <button class='btn btn-danger' type='submit'>Borrar</button></form>";
								echo "</td>";
			...
			<button type="button" class="btn btn-info form-control panel-title" data-toggle="collapse" data-target="#Quadrat5">Alta Grup</button>
				<div id="Quadrat5" class="collapse">
					<div class="panel-body">
							...
							<form action="insertarGrups.php" method="POST">
							  <div class="input-group">
								<div class="form-grup">
					...
					<div class="panel-body">
					   ...
					   // $mysqli = mysqli_connect("localhost", "test", "test", "projectx");
						...
						echo "<td align='center' >";
						  ...
						  echo "<td align='center' >";
						  echo "<form action='eliminarGrup.php' method='POST'><input type='hidden' value='".$row3 ['grup_id']."' name='grup'> <button class='btn btn-danger' type='submit'>Borrar</button></form>";
						  echo "</td>";
						 ...
						 if (isset($_POST['grup'])){ 
						  if ($row3['grup_id']== $_POST['grup']){
							echo "<tr>";
							echo "<form action='editarGrup.php' method='POST'>";
							echo "<td align='center' >";
					...
					<div class="panel-body">
						...
						$rowcount=mysqli_num_rows($taulaUsuaris);
							...
							echo "<tr><th align='center'>&nbspAlumne&nbsp</th><th align='center'>&nbspGrup&nbsp</th> <th align='center'>&nbspAssignar&nbsp</th></tr>";
								...
								echo "<form action='assignacioFinal.php' method='POST'>";
					...
					<div class="panel-body">
						...
						$rowcount=mysqli_num_rows($taulaUsuaris);
							...
							echo "<tr><th align='center'>&nbspAlumne&nbsp</th><th align='center'>&nbspGrup&nbsp</th><th align='center'>&nbspBorrar&nbsp</th></tr>";
								...
								echo "<td align='center' >";
									  echo "<form action='borrarAlumneGrup.php' method='POST'> <input type='hidden' value='".$row['usuari_id']."' name='eliminar'> <button class='btn btn-danger' type='submit'>Borrar</button></form> ";
									  echo "</td>";
